<?php /* Template Name: Gateway Verify */ get_header();?>
    ...
    <table id="gateway-users" width="100%" style="width:100%">
        ...
        <tbody width="100%">
            ...
            <tr width="100%">
                ...
                <td><button onclick="location.href='<?php echo site_url();?>/innasol-partner-gateway/edit-user/?id=<?php echo $user->ID;?>';" class="user-view" id="<?php echo $user->ID;?>">Edit</button> <button class="delete_user" delete-user-id="<?php echo $user->ID;?>">Delete</button></td>
            </tr>
            <?php };?>
        </tbody>
    </table>
