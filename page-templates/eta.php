...
<div class="whatWeDoSubPage">
    ...
    <div class="whatWeDoRange">
        <div class="divider" style="background-image: url(<?php echo get_template_directory_uri();?>/images/header_section_what_we_do_eta_boilers.jpg)">
            <div class="shard">
                <div class="angle"></div>
        ...
        <div class="productsList">
            <div class="container">
                <?php $loop = new WP_Query(array('post_type' => 'product','posts_per_page' => -1,'tax_query' => array(array ('taxonomy' => 'range','field' => 'slug','terms' => 'eta-biomass-boilers',)),)); while ( $loop->have_posts() ) : $loop->the_post(); ?>
