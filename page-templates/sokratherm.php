...
<div class="whatWeDoSubPage">
    ...
    <div class="eta " style="border-top-color: #0190d4;">
        <div class="etaContent">
            <p style="background-color: #0190d4; color: #ffffff"><?php the_field('strapline');?></p> <span class="etaLogo" style="border-top-color: #0190d4;"><img src="<?php echo get_template_directory_uri();?>/images/combined-heat-and-power-system.png" /></span>
        </div>
    </div>
    <div class="page">
        <div class="container">
    ...
    <div class="whatWeDoRange">
        ...
        <div class="productsList">
            <div class="container">
                <?php $loop = new WP_Query(array('post_type' => 'product','posts_per_page' => -1,'tax_query' => array(array ('taxonomy' => 'range','field' => 'slug','terms' => 'sokratherm-chp-units',)),)); while ( $loop->have_posts() ) : $loop->the_post(); ?>
