<?php /* Template Name: Product - Kohlback */ get_header();?>
...
<div class="whatWeDoSubPage">
    ...
    <div class="eta Kohlbach" style="border-top-color: #ef1202;">
        <div class="etaContent">
            <p style="background-color: #ef1202; color: #ffffff"><?php the_field('strapline');?></p> <span class="etaLogo" style="border-top-color: #ef1202;"><img src="<?php echo get_template_directory_uri();?>/images/logo-web.jpg" /></span>
        </div>
    </div>
    <div class="page">
        <div class="container">
    ...
    <div class="whatWeDoRange">
        <div class="divider" style="background-image: url(<?php echo get_template_directory_uri();?>/images/Kohlbach-2-1.jpg)">
            <div class="shard">
                <div class="angle"></div>
        ...
        <div class="productsList">
            <div class="container">
                <?php $loop = new WP_Query(array('post_type' => 'product','posts_per_page' => -1,'tax_query' => array(array ('taxonomy' => 'range','field' => 'slug','terms' => 'kohlbach-biomass-boilers',)),)); while ( $loop->have_posts() ) : $loop->the_post(); ?>
