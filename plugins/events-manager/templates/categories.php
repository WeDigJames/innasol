...
<div class="filters">
  <div class="thirds-grid">
      <div id="item-0" class="a">
         <div class="filter--wrapper">
            [wpv-control-post-taxonomy taxonomy="event-categories" type="radios" default_label="All" class="filter--wrapper" url_param="wpv-event-categories"]
        </div> 
      </div>
      <div id="item-1" class="b">
        <div class="panel">
          <span style="margin-right:1rem">Showing [wpv-items-count] of [wpv-found-count]</span> [wpv-pager-nav-links output="bootstrap"]
        </div>
      </div>
	</div>   
</div>